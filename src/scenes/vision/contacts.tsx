          ...
          <div className="mx-auto flex w-4/6 flex-row gap-[50px] bg-white p-6">
            ...
            <div className="flex basis-3/5 flex-col gap-3">
              ...
              <p className="text-2xl text-gray-400">
                Dr. Richard Imamoto Optometry in Torrance offers many options
                for contact lenses.
              </p>
              <p className="">
                There are a number of reasons why you might prefer contact
                lenses to standard eyewear: a glasses-free look, hassle-free
                vision correction, wearing non-prescription sunwear and goggles,
                or the convenience of not having to worry about misplacing your
                glasses. If you have a high prescription or astigmatism, contact
                lenses may provide more enhanced vision correction than glasses.
                Today, you can even replace your bifocal glasses with bifocal
                contact lenses.
              </p>
              <p className="pb-5">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p>
                  ...
                  monthly, weekly or daily depending on the type you choose.
                  Soft lenses are often recommended for sports because they fit
                  closer to the eye and are more difficult to dislodge. They can
                  provide correction for most prescriptions including
                  astigmatism. Today, with the introduction of newer materials
                  like silicone hydrogels, which allow more oxygen to the eye,
                  patients find it easier than ever to wear soft lenses
                  comfortably.
                </p>
                ...
                <p>
                  ...
                  contact lenses are fun and come in a variety of colors for
                  both light and dark eyes.
                </p>
                <p className="text-2xl">Silicone Hydrogels</p>
                <p>
                  Silicone hydrogels are soft contact lenses that have high
                  oxygen permeability and are comparable to GP lenses.
                </p>
                <p>
                  Regardless of the type of contact lenses you wear, an annual
                  eye exam is recommended to ensure the continued good health of
                  your eyes. Request an appointment for an assessment and advice
                  at Dr. Richard Imamoto Optometry in Torrance, and we will be
