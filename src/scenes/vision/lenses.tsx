        ...
        <div className="mx-auto flex gap-[50px] bg-white p-6 xs:flex-col sm:flex-col md:w-4/6 md:flex-row">
          ...
          <div className="flex basis-3/5 flex-col gap-3">
            ...
            <p className="">
              ...
              variety of options are available that can be tailored to suit not
              only your medical needs but also your fashion preferences.
            </p>
            <p className="pb-5">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p>
                ...
                make up a pair of prescription lenses. It is important to select
                the right combination of these elements for your particular
                visual needs and to always consult your eye care professional.
              </p>
              <p>
                The knowledgeable staff at Dr. Richard Imamoto Optometry will
                consider long-term wearing comfort, style, features and function
                when suggesting a new pair of eyeglasses. The eyeglasses become
                as unique as the person taking them home.
              </p>
              <p className="text-2xl">Eyeglass Lenses</p>
              <p>
                Selecting the right eyeglass lens depends largely on its
                function. From single vision lenses to progressive polycarbonate
                lenses, we are happy to help you find what best suits your
                needs. Regardless of your situation, your eye care provider can
                help determine what types of lenses will work best for you in
                terms of comfort, function and design.
              </p>
              ...
              <p>
                ...
                more than one pair of glasses, such as one for everyday wear and
                another for outdoor activities. Having different style frames
                for different activities and moods makes wearing glasses more
                fun.
              </p>
              ...
              <p>
                ...
                vision problems caused by sunlight such as cataracts and retinal
                damage.
              </p>
              <p>
                Glare, an issue that makes it difficult to see objects clearly
                by washing out colors and details, can be combated by polarized
                lenses. Looking at a scene with polarized lenses, you’ll notice
                the colors are deeper, richer and bolder, and details are
                clearer and more distinct. Polarized lenses also help reduce
                squinting, which, in turn, reduces eye fatigue, tension and
                eyestrain.
              </p>
              ...
              <p>
                ...
                bouncing off their lenses. This glare makes it more difficult to
                see, especially at night. Anti-reflective lenses reduce these
                reflections allowing more light to pass through to your eyes.
              </p>
              <p>
                All lens surfaces naturally reflect light and this reflection
                can prevent between seven to 14 percent of the light needed for
                optimal vision. Wearing non-AR lenses is like trying to read a
                book in a dimly lit room. Since AR lenses allow more light to
                reach your eyes by reducing reflections, it’s like turning up
                the lights in a room, making it easier to see.
              </p>
              <p>
                Lenses and frames are a very necessary and personal choice. Dr.
                Richard Imamoto Optometry in Torrance, California has the
